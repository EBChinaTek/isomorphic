...
function whatToSay(sequence){
  ...
  if((devisibleByThree && divisibleByFive) || (containsThree && containsFive)) return ['Fizz','Buzz'].join('')
...
[15, 35, 45, 53, 60, 75, 90].forEach(sequence=>console.assert(whatToSay(sequence)==='FizzBuzz', `第${sequence}个同学应该说FizzBuzz`));
